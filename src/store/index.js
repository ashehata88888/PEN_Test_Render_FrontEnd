...
const marketDataSlice = createSlice({
  ...
  reducers: {
    ...
    updateMarketSizeRowID: (state, action) => { state.marketSize[0].marketSizeRowID = action.payload },
    updateSupplier_id: (state, action) => { state.marketSize[0].supplier_id = action.payload },
    updateProduct_family_id: (state, action) => { state.marketSize[0].product_family_id = action.payload },
    updateItem_group_id: (state, action) => { state.marketSize[0].item_group_id = action.payload },
    updateMarket_potential_id: (state, action) => { state.marketSize[0].market_potential_id = action.payload },
